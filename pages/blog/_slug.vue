...
<div class="max-w-7xl mx-auto border-gray-700 border-dashed border-l border-r">
  <div class="dark antialiased text-gray-200">
    <div class="px-4 py-4 max-w-5xl mx-auto sm:px-6 lg:px-8">
      <article>
        <div class="space-y-9">
          <div class="space-y-10 py-0.5 border-t border-b border-dashed border-gray-700 sm:space-y-0 flex items-center justify-between">
          ...
          <div class="px-4 sm:px-0 lg:px-4 pb-4 bg-gray-900 rounded-lg">
                ...
                <dl class="">
                  <div><dt class="sr-only">Published on</dt>
                    <dd class="text-xs font-medium text-gray-500">
                      <a target="_blank" :href="`https://twitter.com/${article.author.twitter}`"><span class="text-indigo-600 hover:text-indigo-300">{{ article.author.name }}</span></a>
            ...
            <div class="prose dark:prose-light my-10 prose-sm max-w-4xl mx-auto">
  ...
  <div v-scroll-to="'#outline'" class="cursor-pointer fixed z-50 bottom-4 right-4 w-12 h-12 rounded-full bg-gray-900 text-white block text-indigo-600 hover:text-hot-pink">
