<template>
  <footer class="bg-gray-800">
    <div data-aos="fade-up" class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-12 lg:px-8">
      <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          ...
          <a v-if="$store.state.social.instagram" target="_blank" :href="`https://instagram.com/${$store.state.social.instagram}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.twitter" target="_blank" :href="`https://twitter.com/${$store.state.social.twitter}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.github" target="_blank" :href="`https://github.com/${$store.state.social.github}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.linkedin" target="_blank" :href="`https://linkedin.com/in/${$store.state.social.linkedin}`" class="text-gray-400 hover:text-gray-300">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
          &copy; 2020 - present • {{ $store.state.name }}. all rights reserved.
        </p>
      </div>
    </div>
  </footer>
