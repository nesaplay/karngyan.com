<template>
  <footer class="bg-gray-800">
    <div data-aos="fade-up" class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-12 lg:px-8">
      <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          <a target="_blank" href="https://facebook.com/karnsometimes" class="text-gray-400 hover:text-gray-300">
          ...
          <a target="_blank" href="https://instagram.com/karngyan" class="text-gray-400 hover:text-gray-300">
          ...
          <a target="_blank" href="https://twitter.com/gyankarn" class="text-gray-400 hover:text-gray-300">
          ...
          <a target="_blank" href="https://github.com/karngyan" class="text-gray-400 hover:text-gray-300">
          ...
          <a target="_blank" href="https://linkedin.com/in/karngyan" class="text-gray-400 hover:text-gray-300">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
          &copy; 2020 - present • gyan prakash karn. all rights reserved.
        </p>
      </div>
    </div>
  </footer>
