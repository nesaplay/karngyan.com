      ...
      <div class="flex-1 bg-gray-900 p-5 flex flex-row justify-between">
        <div class="flex-1 flex flex-col justify-between">
          ...
          <div class="flex mt-2 space-x-2 flex-row">
            <a target="_blank" :href="project.website" class="hover:text-indigo-500 text-gray-600">
            ...
            <a target="_blank" :href="project.github" class="hover:text-indigo-500 text-gray-600">
